...
/**
 * The Fabric implementation of the {@link DataProviderGatherer}.
 */
public class FabricDataProviderGatherer implements DataProviderGatherer {
     ...
     */
    public FabricDataProviderGatherer(DataGenerator.PackGenerator pack, String modId, CompletableFuture<HolderLookup.Provider> registries, ExtensionManager.Loader<FabricGathererExtensionsProvider> loader) {
        this.pack = pack;
